            ...
            >
              {user && (
                <li onClick={handleClick}>
                  <span className="text-yellow-700">Logout</span>
                </li>
              )}
          ...
          <div className="hidden md:block">
            {user && (
              <div>
                <button
                  onClick={handleClick}
                  className="btn btn-ghost text-yellow-700 hover:bg-yellow-800 hover:text-base-100 outline outline-1 outline-yellow-700 hover:border hover:border-yellow-800"
                >
                  Log out
                </button>
              </div>

    ...
    <div className="mb-4 mt-6 lg:max-w-xl mx-auto">
      <div className="card lg:w-96 bg-base-100 shadow-xl lg:h-[500px] flex flex-col">
        <form
          ...
          className="card-body justify-between text-lg lg:text-xl"
        >
          ...
          <div className="mt-4 font-gaegu uppercase flex flex-col text-yellow-700">
            <label htmlFor="name" className="font-bold p-0.5">
              Name:
            </label>
            <input
              id="name"
            ...
            <label htmlFor="email" className="font-bold p-0.5">
              Email:
            </label>
            <input
              id="email"
            ...
            <label htmlFor="password" className="p-0.5">
              Password:
            </label>
            <input
              id="password"
          ...
          <button
            ...
            className="bg-yellow-700 font-gaegu m-1 rounded-md w-full tracking-widest hover:bg-yellow-800 text-base-100 text-lg lg:text-xl "
          >
            Sign Up
          </button>
